...
<head>
	<meta charset="utf-8" />
	<title>Voucher Management Platform</title>
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td>
                                                        <a href=""><img src="{{$message->embed(asset('da-logo.png'))}}" height="50px" /></a>
                                                    </td>
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td class="text-right valign-middle">
                                                        <span class="template-label">OTP Email</span>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    <h4>Welcome to Voucher Management Platform.</h4>
                                                    <p class="m-b-5">Your one time password is:</p>
                                                </td>
                                            </tr>                                           
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <h4 style="color:#66BB6A">{!!$otp_code!!}</h4>
                                                    <p>
